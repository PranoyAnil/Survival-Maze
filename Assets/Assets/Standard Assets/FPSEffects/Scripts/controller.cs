...
public class controller : MonoBehaviour {
	...
	void Start () 
	{
        ...
        UnityEngine.GameObject goBulletImpactCTRL = UnityEngine.GameObject.FindGameObjectWithTag ("Bullet_Impacts_Control");
	...
	void FireBullet()
	{
		...
		if ( hit.collider != null )
		{
            ...
            UnityEngine.GameObject objectHit = hit.collider.gameObject;
			if ( objectHit != null )
			{
