...
public class Game : MonoBehaviour {
	...
	public UnityEngine.GameObject[]	barrels;
	...
	void CountBarrels()
	{
        numberOfBarrels = UnityEngine.GameObject.FindGameObjectsWithTag ("Barrels").Length;
	}
	...
	void SpawnBarrel()
	{
        ...
        UnityEngine.GameObject barrel = (UnityEngine.GameObject)Instantiate(barrels[ (int)Random.Range (0, barrels.Length)], spawnPoint.position, spawnPoint.rotation);
